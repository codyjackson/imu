...
{
  i2c_helper::write_to_register(DEVICE, DATA_FORMAT, 0x0A);
  i2c_helper::write_to_register(DEVICE, POWER_CTL, 0x08);
}
...
const Vec3i Accelerometer::get_acceleration() const
{
  ...
  i2c_helper::read_from_register(DEVICE, DATAX0, totalNumOfBytes, buffer);
